...
if ! [[ -f serverinstall_95_2125 ]]; then
	mv /serverinstall_95_2125 /data/serverinstall_95_2125
	rm -fr config defaultconfigs kubejs libraries log4jfix mods resourcepacks minecraft-server-1.18.2.jar version.json start.sh run.* user_jvm_args.txt
	./serverinstall_95_2125 -auto
fi
